...
public class JwtTokenUtil implements Serializable {
    ...
    public String generateAccessToken(UserCredential user) {
        ...
        claims.put("roles", user.getRoles().stream().map(x-> new SimpleGrantedAuthority(x.getRname())).collect(Collectors.toList()));
    ...
    public String generateRefreshToken(String subject) {
        ...
        return Jwts.builder()
                ...
                .setIssuer("system")
                .setIssuedAt(new Date(System.currentTimeMillis()))
                .setExpiration(new Date(System.currentTimeMillis() + JWTConstants.RFERESH_TOKEN_VALIDITY_SECONDS * 1000))
                .signWith(SignatureAlgorithm.HS256, JWTConstants.SIGNING_KEY)
                .compact();
    }
